...
export function ColorSwatchSection({ className }: { className?: string }) {
...
function SwatchContainer({
	...
	return (
		<div
			className={cn([
				"grid grid-cols-2 gap-y-1 rounded-2xl border-[color-mix(in_oklab,_var(--gray-8)_20%,_transparent)] border-x-2 p-4",
				className,
			])}
		>
			{children}
