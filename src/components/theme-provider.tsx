/**
 * From https://gist.github.com/WellDone2094/16107a2a9476b28a5b394bee3fa1b8a3
 */
 ...
 */
const _defaultContext: UseThemeProps = { setTheme: (_) => {}, themes: [] };
	...
	const setTheme = React.useCallback(
		...
		(value: any) => {
			...
			try {
				 ...
				 */
				console.error(
					"Local storage 'setItem' is not supported on this device",
				);
			}
		},
		[theme],
...
const getTheme = (key: string, fallback?: string) => {
	...
	try {
		 ...
		 * Modified from original gist
		 */
		console.error("Local storage 'getItem' is not supported on this device");
	}
