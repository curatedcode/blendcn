...
export function InputGroupPreview() {
	return (
		<ComponentAccordionGroup title="Input Group">
			...
			<ComponentAccordionSubGroup title="Text">
				<InputGroupTextDemo />
			</ComponentAccordionSubGroup>
			...
			<ComponentAccordionSubGroup title="Spinner">
				<InputGroupSpinner />
			</ComponentAccordionSubGroup>
			<ComponentAccordionSubGroup title="Label">
				<InputGroupLabel />
			</ComponentAccordionSubGroup>
			<ComponentAccordionSubGroup title="Dropdown">
				<InputGroupDropdown />
			</ComponentAccordionSubGroup>
			<ComponentAccordionSubGroup title="Button Group">
				<InputGroupButtonGroup />
			</ComponentAccordionSubGroup>
			<ComponentAccordionSubGroup title="Custom Input">
				<InputGroupCustom />
			</ComponentAccordionSubGroup>
		</ComponentAccordionGroup>
	);
...
function InputGroupButtonGroup() {
	return (
		<div className="grid w-full max-w-sm gap-6">
			<ButtonGroup>
