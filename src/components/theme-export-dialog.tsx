		...
		<Dialog>
			<div className="rounded-md bg-muted">
				<DialogTrigger asChild>
					<Button
						variant={"outline"}
						className="w-48 bg-background hover:bg-[color-mix(in_oklab,var(--color-background)_96%,#000)] dark:border-input/80 dark:bg-input/30 hover:dark:bg-input/50"
					>
						Export Theme
					</Button>
				</DialogTrigger>
			</div>
			<DialogContent className="max-h-[calc(100%-0.5rem)] max-w-[calc(100%-0.5rem)] overflow-y-auto px-3 py-6 sm:max-w-5xl md:max-h-[calc(100%-2rem)] md:p-6 md:pt-6">
				<DialogHeader>
												...
												<FormControl>
													...
													>
														<FormItem className="flex items-center gap-2">
															...
															<FormLabel className="font-normal">Tab</FormLabel>
														</FormItem>
														<FormItem className="flex items-center gap-2">
															<FormControl>
