...
type UseSessionStorageOptions<T> = {
	...
	/**
	 * If `true`, the hook will initialize reading the session storage. In SSR, you should set it to `false`, returning the initial value initially.
	 * @default true
	 */
...
export function useSessionStorage<T>(
	...
	// biome-ignore lint/correctness/useExhaustiveDependencies: only want to react to key update
	React.useEffect(() => {
